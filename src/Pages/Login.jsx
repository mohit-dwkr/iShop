      ...
      <div className='w-full max-w-md p-8 space-y-4 bg-white shadow-lg rounded-xl'>
        ...
        <form action="" className='space-y-6'>
          ...
          <div>
            ...
            className='w-full px-4 py-2 text-gray-700 bg-gray-50 border border-gray-400 rounded-lg focus:ring focus:ring-blue-400 focus:outline-none' 
            required />
          </div>
          {/* password input */}
          <div className='relative'>
            ...
            <div className='items-center flex relative'>
              ...
              className='w-full px-4 py-2 text-gray-700 bg-gray-50 border border-gray-400 rounded-lg focus:ring-red-300 focus:outline-none'
              required
              />
          ...
          {/* submit button */}
          <button type='submit' className='w-full px-4 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring focus:ring-red-300'>Login</button>
