            ...
            <div className='grid grid-cols-1 px-4 md:px-0 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 py-6 max-w-7xl mx-auto'>
                ...
                <div className='relative h-[250px] '>
                    ...
                    <div className='absolute inset-0 bg-gray-800/50 rounded-lg flex flex-col items-center justify-center'>
                        ...
                        <button className='mt-2 px-3 py-1 bg-white text-blue-800 rounded-md shadow hover:bg-gray-300 cursor-pointer'>Discover</button>
                    </div>
                </div>

                {/* second banner  */}
                <div className='relative h-[250px] '>
                    <img src="https://images.pexels.com/photos/5650023/pexels-photo-5650023.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="New Arrivals" className='w-full h-full object-cover rounded-lg shadow-lg' />
                    <div className='absolute inset-0 bg-gray-800/50 rounded-lg flex flex-col items-center justify-center'>
                ...
                <div className='relative h-[250px] col-span-1 sm:col-span-2'>
                    ...
                    <div className='absolute inset-0 bg-orange-800/50 flex flex-col items-center rounded-lg justify-center '>
                        <h2 className='text-white text-4xl  font-bold '> Season Sale</h2>
                        <p className='text-white my-2 text-lg '>Up To 70% Of</p>
                ...
                <div className='relative h-[250px] col-span-1 sm:col-span-2'>
                    ...
                    <div className='absolute inset-0 bg-red-800/50 flex flex-col items-center rounded-lg justify-center '>
                        <h2 className='text-white text-4xl  font-bold '> Season Sale</h2>
                ...
                {/* fifth banner  */}
                <div className='relative h-[250px] '>
                    <img src="https://images.pexels.com/photos/5622859/pexels-photo-5622859.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="New Arrivals" className='w-full h-full object-cover rounded-lg shadow-lg' />
                    <div className='absolute inset-0 bg-gray-800/50 rounded-lg flex flex-col items-center justify-center'>
                        <h2 className='text-white text-2xl font=bold '>Limited Offer </h2>
